...
// â”€â”€ FAQ / User Guide data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const GUIDE_SECTIONS = [
  {
    ...
    details: `The Interview is where your story begins. Choose one of our AI interviewers â€” each has a different style, from warm and personal to journalistic and structured.

How it works:
â€¢ Tap the microphone and speak your answer naturally â€” the AI listens and transcribes in real time
â€¢ After each answer, the interviewer asks a follow-up question tailored to what you shared
â€¢ Interviews are organised into phases: Early Life, Family, Career, Challenges, Legacy
â€¢ You can pause and resume any time â€” your progress is saved automatically

Tips:
â€¢ Speak in full sentences and take your time â€” there's no rush
â€¢ Mention names of people and places â€” the app captures them automatically
â€¢ If the AI mishears a word, tap the text area to correct it before submitting

To edit or delete: Go to the interview session, tap the answer you want to change, and edit the text directly. To delete an entire session, use the session menu (â‹¯).`,
  },
  {
    icon: Star,
    color: "#c84a9a",
    title: "Re-Live",
    summary: "Transforms your story into a beautiful illustrated storyboard â€” like a movie of your life.",
    details: `Re-Live takes the story you've shared and turns it into a series of illustrated panels, each with an image, title, and caption â€” like a graphic novel or movie storyboard.

How it works:
â€¢ Step 1: Choose a story â€” either from an interview session or type/speak your own
â€¢ Step 2: Optionally upload a reference photo so the AI can match the appearance of your subject
â€¢ Step 3: Choose your art style (Cinematic, Illustrated, or Graphic Novel) and panel count (12 or 16)
â€¢ The AI plans the key visual moments, generates each panel image, and composes the final storyboard
â€¢ Download the finished storyboard as a high-quality image

Art styles:
â€¢ Cinematic Concept Art â€” photorealistic, dramatic lighting, film-quality
â€¢ Illustrated Story â€” warm, painted, storybook feel
â€¢ Graphic Novel â€” bold lines, high contrast, comic-book style

Tips:
â€¢ More detail in your story = better panels â€” use the AI Refine button on Step 1 to improve your input
â€¢ The age selector helps the AI render characters at the right life stage
â€¢ Previously generated storyboards appear at the top of Step 1 â€” tap to view or download`,
  },
  {
    icon: Clock,
    color: "#6a8a4a",
...
What appears here:
â€¢ Life milestones (births, marriages, moves, career changes)
â€¢ Specific dates and years you mentioned
â€¢ Key events described in your answers

How to edit:
â€¢ Timeline entries are derived from your interview answers â€” to correct a date or event, go back to the interview exchange that mentioned it and edit the answer
â€¢ The timeline refreshes automatically when you update an interview
...
Note: If a date is approximate (e.g. "in my thirties"), it will appear as an estimated period rather than a specific year.`,
  },
  {
    ...
    color: "#4a7a8a",
    title: "People",
    summary: "Everyone you mention in your interviews â€” family, friends, mentors â€” collected in one place.",
    details: `The People section automatically identifies and lists every person you mention across all your interviews â€” their name, relationship to you, and how many times they appear.

How it works:
â€¢ The AI extracts names and relationships from each answer as you go
â€¢ Each person card shows their name, relationship, and memorable quotes about them
â€¢ Tap a card to expand it and see what you said

Correcting a name:
â€¢ If the AI got a name wrong (e.g. "DB" instead of "Bebe"), tap the pencil âœ icon on the person's card
â€¢ Enter the correct name and relationship, then tap Save correction
â€¢ This automatically updates every interview exchange that mentions that person â€” in your device and in the cloud`,
  },
  {
    icon: MapPin,
    color: "#8a4a8a",
    title: "Places",
    summary: "Every location mentioned in your story â€” cities, homes, schools, places of work.",
    details: `Places captures every location you mention across your interviews â€” from the town you grew up in to the school you attended and the cities you've lived in.

Each place card shows:
â€¢ The place name and type (city, home, school, workplace, etc.)
â€¢ How many times it appears in your story
â€¢ Context quotes from your interviews
...
To edit: Like People, places are derived from your interview answers. To correct a place name or type, find the interview exchange where you mentioned it and update the answer.`,
  },
  {
    ...
    color: "#8a8a2a",
    title: "Life Lessons",
    summary: "The wisdom and insights the AI extracts from your story â€” the things you've learned.",
    details: `Life Lessons captures the wisdom, advice, and insights woven through your story â€” the things you've learned from hard times, good times, and everything in between.
...
To add more: The best way to enrich this section is to complete more interviews â€” especially when answering questions about challenges, regrets, and advice you'd give to younger generations.`,
  },
  {
    icon: BookOpen,
    color: "#3a6a8a",
...
How it works:
â€¢ Tap Generate Biography and choose a writing style
â€¢ The AI reads all your interview answers and composes a multi-chapter narrative
â€¢ Chapters are organised by life phase: Early Life, Family & Relationships, Career, Challenges & Growth, Legacy

Tips:
â€¢ The more interviews you complete, the richer the biography
â€¢ You can regenerate at any time to incorporate new interview sessions
â€¢ Copy the text to paste into a Word document, email, or print

To edit: The biography is AI-generated text â€” copy it and edit in any word processor. We plan to add direct in-app editing soon.`,
  },
  {
    icon: Scroll,
    color: "#8a5a2a",
    title: "Legacy",
    summary: "AI-generated letters and documents â€” for your children, grandchildren, or anyone who comes after.",
    details: `Legacy lets you generate heartfelt personal documents drawn from your story â€” letters to your children, values statements, wishes for your family.

Available templates:
â€¢ Letter to My Children â€” values, lessons, and wishes
â€¢ Letter to Future Grandchildren â€” introducing who you were
â€¢ My Core Values â€” the principles you lived by
â€¢ Wishes for My Family â€” hopes, not material wishes

How it works:
â€¢ Choose a template (or write a custom prompt)
â€¢ The AI reads your interviews and writes the document in your voice
â€¢ Copy to share, print, or save
...
To delete a saved document: Tap the trash icon that appears when you hover over a document in the sidebar.`,
  },
  {
    ...
    details: `Family Memories lets you invite people who know you â€” children, siblings, old friends â€” to add their own memories alongside yours.

How to invite:
â€¢ Go to Family Memories and tap Invite
â€¢ Enter their email address, their name, and an optional personal message
â€¢ They receive an email with a personal link â€” no account needed
â€¢ They fill in their name, relationship, story, and can attach photos (up to 3 photos, 40MB each)

Viewing contributions:
â€¢ Each invite card shows a green "contributed" badge when someone responds
â€¢ Tap the card to expand and read their full memory and see any photos they shared
â€¢ The bell icon in the top bar shows a badge when new contributions arrive

Note: Each invite link is single-use â€” once someone submits, the link is marked as contributed.`,
  },
  {
    icon: Lock,
    color: "#5a5a8a",
...
Coming soon â€” full upload, tagging, and sharing features are planned for a future update.`,
  },
];
...
const FAQS = [
  ...
  { q: "What happens if the AI gets a name wrong?", a: "Go to the People section and tap the pencil âœ icon on the incorrectly named person. Enter the correct name and relationship and tap Save â€” this updates every interview that mentioned that name." },
  ...
  { q: "How do I reset my password?", a: "On the sign-in screen, tap 'Forgot password?' below the password field and enter your email address. You'll receive a password reset email within a few minutes â€” check your spam folder if it doesn't arrive. Tap the link in the email (it expires after 1 hour), enter your new password twice, and you'll be signed in automatically. You can also change your password at any time when signed in via Settings â†’ Password tab." },
  { q: "Can family members use the app without an account?", a: "Yes â€” for contributing memories only. When you send a Family Memories invite, the recipient receives a personal link. They can submit a memory and photos without creating an account. To use the full app (interviews, Re-Live, etc.) an account is required." },
  { q: "How long does Re-Live take to generate?", a: "A 12-panel Premium storyboard typically takes 3â€“5 minutes as each panel image is generated individually at high quality. You'll see a live progress bar. Don't close the page while it's generating." },
  { q: "Can I change the art style after generating a storyboard?", a: "Yes â€” go back to Re-Live, select the same story, choose a different art style, and generate again. Previous storyboards are saved and accessible from the gallery at the top of Step 1." },
...
// â”€â”€ Support chat â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        <div className="px-4 pb-4 border-t" style={{ borderColor: `${section.color}20` }}>
          <div className="pt-3 space-y-2">
            {section.details.split("\n").map((line, i) => (
              line.trim() ? (
                <p key={i} className={`font-serif text-sm leading-relaxed ${line.startsWith("â€¢") ? "pl-3" : ""}`}
                  style={{ color: line.startsWith("â€¢") ? "rgba(210,175,100,0.75)" : line.endsWith(":") ? "#c8a050" : "rgba(235,205,120,0.97)", fontWeight: line.endsWith(":") ? "600" : "400" }}>
                  {line}
                </p>
...
export default function SupportPage() {
  ...
  async function sendMessage(text: string) {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role: "assistant", content: data.answer ?? "I'm not sure about that â€” please email support@historydrift.com." }]);
    } catch {
        ...
        <div className="flex-shrink-0 px-4 pb-4 pt-2 border-t" style={{ borderColor: "rgba(80,50,15,0.2)", background: "rgba(10,6,2,0.6)" }}>
          <div className="flex gap-2">
            <input value={input} onChange={e => setInput(e.target.value)}
              ...
              placeholder="Ask a support questionâ€¦" disabled={loading}
