...
const FAQS = [
  ...
  { q: "How do I reset my password?", a: "On the sign-in screen, tap 'Forgot password?' and enter your email. You'll receive a reset link. You can also change your password in Settings → Password tab." },
