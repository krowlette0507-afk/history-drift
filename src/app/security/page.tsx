...
You can also request deletion at any time from Settings → Delete my account. Once deletion is confirmed, it cannot be undone.
    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <p className="font-serif italic text-sm mb-4" style={{ color: "rgba(180,130,60,0.7)" }}>
            Last updated: 15 July 2026
          </p>
          <p className="font-serif text-sm leading-relaxed" style={{ color: "rgba(210,175,100,0.8)" }}>
        ...
        >
          ...
          <Link
            ...
            style={{ color: "rgba(160,110,50,0.7)" }}
          >
            Privacy Policy →
          </Link>
        </div>
